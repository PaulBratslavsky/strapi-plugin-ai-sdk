...
function MemoryModal({ memory, open, onClose, onSave }: MemoryModalProps) {
  ...
  return (
    <Modal.Root open={open} onOpenChange={(isOpen: boolean) => !isOpen && handleClose()}>
      <WideModalContent>
        <Modal.Header>
          <Modal.Title>{isEdit ? 'Edit Memory' : 'Add Memory'}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Flex direction="column" gap={5} width="100%">
            ...
            <Field.Root width="100%">
              ...
              >
                ...
                <SingleSelectOption value="preference">Preference</SingleSelectOption>
                <SingleSelectOption value="personal">Personal</SingleSelectOption>
                <SingleSelectOption value="project">Project</SingleSelectOption>
              </SingleSelect>
              <Field.Hint>Used to organize memories by topic</Field.Hint>
            </Field.Root>
          </Flex>
        </Modal.Body>
        <Modal.Footer>
